...
$full_name = $phone = $region =$email = $personalno = $designation = $output = $sessionid = $access_token = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if (!$adaccount) {
            ...
            //   $encryptionKey = '1e500ac261ba47ab727d4a6cb882d3ec';
...
//                                                $perms[] = $permId;
                            ...
                            $httpResponseCode = 401;
                            $error = "Authentication failed";
                            $message = "User $adaccount not found.";
                        }
